          ...
          <div className="card shadow-lg" id="no-scale" >
            <div className="row g-0">
              <div className="col-md-6 col-lg-5 d-none d-md-block">
                <Image src="/job-somely-sign-up1.jpg" alt="signup form" className="img-fluid h-100 rounded shadow-lg" />
              </div>
              <div className="col-md-6 col-lg-7 d-flex align-items-center">
                <div className="card-body p-4 p-lg-5 text-black">
                  ...
                  <Form onSubmit={handleSignupSubmit}>
                    ...
                    <h5 className="fw-normal mb-3 pb-3 text-success fw-bold">Create your account</h5>
                    ...
                    <div className="pt-1 mb-4">
                      <Button className="bg-success btn-lg w-100" type="submit">Register</Button>
                    </div>
